...
def update_object_schema(__type: type, schema: t.Dict[str, t.Any]) -> t.Dict[str, t.Any]:
    """
...
def update_array_schema(__type: type, schema: t.Dict[str, t.Any]) -> t.Dict[str, t.Any]:
    """
...
def update_schema(__type: type, schema: t.Dict[str, t.Any]) -> t.Dict[str, t.Any]:
    """Update type schema"""
    if "anyOf" in schema:
        of_key = "anyOf"
...
def drop_titles(__schema: t.Dict[str, t.Any]) -> t.Dict[str, t.Any]:
...
def transform_to_fc_schema(
    id: str, schema: t.Dict[str, t.Any], params_key: str
) -> t.Dict[str, t.Any]:
    """Transform to LLM function calling format"""
    description_dict: t.Dict[str, str] = {}
...
def extract_python_object(
    __value: t.Any, schema: t.Dict[str, str], value_type: t.Literal["json", "python"]
) -> t.Any:
    """
...
def transform_to_openai_schema(id: str, schema: t.Dict[str, t.Any]) -> t.Dict[str, t.Any]:
    """Transform the schema to openai format"""
    return transform_to_fc_schema(id=id, schema=schema, params_key="parameters")


def transform_to_anthropic_schema(id: str, schema: t.Dict[str, t.Any]) -> t.Dict[str, t.Any]:
    """Transform the schema to anthropic format"""
    return transform_to_fc_schema(id=id, schema=schema, params_key="input_schema")


def transform_to_gemini_schema(id: str, schema: t.Dict[str, t.Any]) -> t.Dict[str, t.Any]:
    """
